...
{
    public class SelectAgilityDescriptionCommand : Command
    {
        public CharacterCreationData CharacterData { get; set; }
        public NewGameViewModel ViewModel { get; set; }
        public SelectAgilityDescriptionCommand(CharacterCreationData characterData, NewGameViewModel viewModel)
        {
        ...
        {
            CharacterData.AttributeDescription = CharacterData.AttributesDescriptionList[4];

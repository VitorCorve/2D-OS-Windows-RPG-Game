...
namespace GameOfFrameworks.Models.UISkillsCollection.Player.Services
{
    public class RogueSkillViewListBuilder : ISkillViewListBuilder
    {
        public List<ISkillView> Get()
        {
            ...
            skill1View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\rogue\\1.jpg";
            ...
            skill2View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\rogue\\2.jpg";
            ...
            skill3View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\rogue\\3.jpg";
            ...
            skill4View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\rogue\\4.jpg";
            ...
            skill5View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\rogue\\5.jpg";

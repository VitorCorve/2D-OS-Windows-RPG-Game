...
namespace GameOfFrameworks.Models.UISkillsCollection.Player.Services
{
    public class WarriorSkillViewListBuilder : ISkillViewListBuilder
    {
        public List<ISkillView> Get()
        {
            ...
            skill1View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\warrior\\relButton\\1.jpg";
            ...
            skill2View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\warrior\\relButton\\2.jpg";
            ...
            skill3View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\warrior\\relButton\\3.jpg";
            ...
            skill4View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\warrior\\relButton\\4.jpg";
            ...
            skill5View.ImagePath = $"{Environment.CurrentDirectory}\\Data\\Images\\skills\\warrior\\relButton\\5.jpg";
